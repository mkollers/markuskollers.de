...
| **Projekte / Cases** | 3–4 kuratierte Cases (Qrafto, Eschomat, vertical desk, packex) als Problem → Lösung → Ergebnis; Live-Links erlaubt. |
...
- **Editorial / Minimal:** typografie-getrieben, großzügiger Weißraum, Zeilen
  ~70 Zeichen.
- **Monochrom + 1 Akzent** (Vorschlag: Orange aus dem bestehenden CV als
  Wiedererkennung). Light/Dark-Mode.
...
- Akzentfarbe final festlegen (Orange aus CV vs. Alternative).
- Schriftwahl (eine Display-/Body-Familie).
- Genaue Case-Auswahl & Texte (Qrafto, Eschomat, vertical desk, packex?).
- Quelle/Workflow für das CV-PDF (aus Daten generieren vs. statisch).
